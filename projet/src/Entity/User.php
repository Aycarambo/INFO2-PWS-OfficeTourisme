...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToOne(targetEntity=Touriste::class, mappedBy="user", cascade={"persist", "remove"})
     */
    private $touriste;
    ...
    public function setTouriste(?Touriste $touriste): self
    {
        ...
        if ($touriste === null && $this->touriste !== null) {
            $this->touriste->setUser(null);
        }

        // set the owning side of the relation if necessary
        if ($touriste !== null && $touriste->getUser() !== $this) {
            $touriste->setUser($this);
        }
